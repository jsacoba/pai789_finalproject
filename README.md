...
We can also run an analysis that counters this relationship as it could also be the case that countries with less exposure risk [hence, lowe WRI], makes them better off economically.
