...
status_scatter.set_title("EPI vs. Lack of Adaptive Capacities per Economic Development Status")
fig.tight_layout()
...
sns.set_style('darkgrid')
status_scatter.set(xlabel='Environmental Performace Index', ylabel='Lack of Adaptive Capacities')
status_scatter.set_title("EPI vs. Lack of Adaptive Capacities per Risk Level")
fig.tight_layout()
